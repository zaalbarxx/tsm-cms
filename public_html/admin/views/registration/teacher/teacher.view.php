        ...
        ?>
          <div class="smallItem">
              ...
              <span class="buttons"><a
                      href="index.php?com=registration&view=student&action=viewTeacher&teacher_id=<?php echo $teacher['teacher_id']; ?>"
                      class="reviewButton" title="Review This Teacher"></a></span>
