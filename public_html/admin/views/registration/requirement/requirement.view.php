...
<div class="contentWithSideBar">
  <h1>Requirements</h2>
  <span style="float: right; margin-top: -45px; right: 20px; position: relative;"><a href="index.php?com=registration&view=requirements&action=addEditRequirement" class="addButton" title="Add a Requirement"></a></span>
  <?php
    if($reqList){
