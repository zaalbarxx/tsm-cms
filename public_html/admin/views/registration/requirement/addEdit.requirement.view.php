...
<div class="contentWithSideBar">
  ...
  <form method="post" style="" action="">
    <fieldset>
      <label for="name">Requirement Name: </label><input type="text" name="name" value="<?php echo $requirement['name']; ?>" /> (ex. Must Be In Highschool) <br />
      <label for="requirement_type_id">Requirement Type: </label><select name="requirement_type_id" id="requirement_type_id" >
