...
<div class="contentWithSideBar">
  ...
  <span style="float: right; margin-top: -45px; right: 20px; position: relative;"><a href="index.php?com=registration&view=programs&action=addEditProgram" class="addButton" title="Add a Program"></a></span>
  <?php
    if($programList){
      foreach($programList as $program){
        ?>
        <div class="bigItem">
          <a class="title" href="index.php?com=registration&view=programs&action=viewProgram&program_id=<?php echo $program['program_id']; ?>"><?php echo $program['name']; ?></a>
