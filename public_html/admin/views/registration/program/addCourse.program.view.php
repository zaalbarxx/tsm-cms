  ...
  <?php if($courses){ ?>
		<?php foreach($courses as $course){ ?>
			<div class="smallItem">
				...
				<span class="buttons">
				<a href="index.php?com=registration&view=programs&action=addCourse&program_id=<?php echo $programInfo['program_id']; ?>&addCourse=<?php echo $course['course_id']; ?>" class="addButton24" title="Add to <?php echo $programInfo['name']; ?>"></a>
				</span>
			</div>  
		<?php } ?>
  <?php } else { ?>
