...
<div class="contentWithSideBar">
  ...
  <?php if(isset($campusFees)){
			...
			<div class="smallItem">
				...
				<span class="buttons">
				<a href="index.php?com=registration&view=programs&action=addFee&program_id=<?php echo $program_id; ?>&addFee=<?php echo $fee['fee_id']; ?>" class="addButton24" title="Add to <?php echo $programName; ?>"></a>
				</span>
			</div>  
		<?php }
  	} else {
