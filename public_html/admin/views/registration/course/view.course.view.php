...
<div class="contentWithSideBar">
    <h1><?php echo $pageTitle; ?> - <a
            ...
            class="editButton" title="Edit Course"></a></h2>
          ...
          foreach ($coursePeriods as $period) {
            ?>
              <div class="smallItem">
                  ...
                  <span class="buttons"><a href="#" class="deleteButton deletePeriod" title="Delete Period"
              ...
              ?>
                <div class="smallItem">
                    ...
                    <span class="buttons"><a href="#" class="deleteButton deleteRequirement" title="Delete Requirement"
                                             ref="<?php echo $requirement['course_requirement_id']; ?>"></a></span>
                </div>
              <?php
            }
          }
            ...
            ?>
              <div class="bigItem">
                  ...
                  <span class="buttons"><a
                          href="index.php?com=registration&view=courses&action=deleteCourseFee&courseId=<?php echo $fee['fee_id']; ?>"
