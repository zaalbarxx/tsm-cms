		...
		<?php foreach($periods as $period){ ?>
			<div class="smallItem">
				...
				<?php foreach($teachers as $teacher){ ?>
					<?php echo $teacher['first_name']." ".$teacher['last_name']; ?> - <a href="index.php?com=registration&view=courses&action=addPeriod&course_id=<?php echo $courseInfo['course_id']; ?>&teacher_id=<?php echo $teacher['teacher_id']; ?>&addPeriod=<?php echo $period['period_id']; ?>" class="addPeriod">Choose</a><br />
				<?php } ?>
				</div>
			</div>  
