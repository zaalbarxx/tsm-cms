...
require_once(__TSM_ROOT__."modules/registration/lib/tsm_registration_payment.model.php");
require_once(__TSM_ROOT__."modules/registration/lib/tsm_registration_family_fee.model.php");
require_once(__TSM_ROOT__."modules/registration/lib/tsm_registration_family_payment_plan.model.php");
require_once(__TSM_ROOT__."modules/registration/lib/tsm_registration_student.model.php");
require_once(__TSM_ROOT__."modules/registration/lib/tsm_registration_teacher.model.php");
require_once(__TSM_ROOT__."modules/registration/lib/tsm_registration_requirement.model.php");
require_once(__TSM_ROOT__."modules/registration/lib/tsm_registration_period.model.php");
require_once(__TSM_ROOT__."modules/registration/lib/tsm_registration_fee_condition.model.php");
require_once(__TSM_ROOT__."modules/registration/lib/tsm_registration_payment_plan.model.php");
require_once(__TSM_ROOT__."modules/registration/lib/tsm_registration_quickbooks.model.php");
