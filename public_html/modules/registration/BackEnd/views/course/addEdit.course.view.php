...
<div class="span9">
    ...
    <form method="post" action="">
        <fieldset>
            <label for="name">Course Name: </label><input type="text" name="name"
                                                          value="<?php echo $courseInfo['name']; ?>"/>
            <br/>
            <label for="course_number">Course Number: </label><input type="text" name="course_number"
                                                                     value="<?php echo $courseInfo['course_number']; ?>"/>
        </fieldset>
        <br/>
        <textarea name="description" class="editor"/><?php echo $courseInfo['description']; ?></textarea>
        ...
        <input type="submit" class="btn btn-primary" style="margin-top: 20px; float: right;" value="Save Course"/>
        <br/><br/><br/>
    </form>
</div>