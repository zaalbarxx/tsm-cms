...
<div class="span9">
    <h1><?php echo $pageTitle; ?> - <a
            href="index.php?mod=registration&view=courses&action=addEditCourse&course_id=<?php echo $courseInfo['course_id']; ?>"
    ...
    <div class="availablePeriods">
        <h3>Available Periods - <a
                href="index.php?mod=registration&view=courses&action=addPeriod&course_id=<?php echo $course_id; ?>"
        ...
        ?>
          <div class="smallItem well well-small">
                  ...
                  <span class="buttons"><a
                          href="index.php?mod=registration&ajax=deletePeriodFromCourse&course_id=<?php echo $courseInfo['course_id']; ?>&course_period_id=<?php echo $period['course_period_id']; ?>"
                          class="deleteButton" title="Delete Period"
                          ref="<?php echo $period['period_id']; ?>"></a><a
                          href="index.php?mod=registration&view=courses&action=changePeriodInCourse&course_id=<?php echo $courseInfo['course_id']; ?>&course_period_id=<?php echo $period['course_period_id']; ?>"
    ...
    <div class="courseRequirements">
        <h3>Enrollment Requirements - <a
                href="index.php?mod=registration&view=courses&action=addRequirement&course_id=<?php echo $course_id; ?>"
        ...
        foreach ($courseRequirements as $requirement) {
          ?>
            <div class="smallItem well well-small">
                ...
                <span class="buttons"><a
                        href="index.php?mod=registration&ajax=deleteRequirementFromCourse&course_id=<?php echo $course_id; ?>&course_requirement_id=<?php echo $requirement['course_requirement_id']; ?>"
    ...
    <div class="courseFees">
        <h3>Applicable Fees - <a
                href="index.php?mod=registration&view=courses&action=addFee&course_id=<?php echo $course_id; ?>"
        ...
        ?>
          <div class="bigItem">
              <span class="title"><?php echo $fee['name']; ?> - $<?php echo $fee['amount']; ?></span>
                  <span class="buttons"><a
                          href="index.php?mod=registration&ajax=deleteFeeFromCourse&course_id=<?php echo $course_id; ?>&course_fee_id=<?php echo $fee['course_fee_id']; ?>"
              ...
              <div class="itemDetails">
                  ...
                  - <a
                      href="index.php?mod=registration&view=courses&action=addCondition&course_id=<?php echo $course_id; ?>&fee_id=<?php echo $fee['fee_id'] ?>"
                      class="fb">Add</a>
                  <br/>
                <?php
                if ($fee['conditions']) {
                  ...
                  foreach ($fee['conditions'] as $condition) {
                    echo "<span id=\"condition_".$condition['course_fee_condition_id']."\">".$i.". ".$condition['name']." - <a href=\"index.php?mod=registration&ajax=deleteFeeConditionFromCourse&course_id=".$course_id."&course_fee_condition_id=".$condition['course_fee_condition_id']."\" class=\"deleteButton button\" title=\"Delete this condition.\"></a></span><br />";
                    $i++;
                  }
                }
                ?>
