...
<div class="span9">
    <h1><?php echo $pageTitle; ?> - <a
            href="index.php?mod=registration&view=programs&action=addEditProgram&program_id=<?php echo $programInfo['program_id']; ?>"
    ...
    <div class="courses">
        <h3>Available Courses - <a
                href="index.php?mod=registration&view=programs&action=addCourse&program_id=<?php echo $program_id; ?>"
          ...
          foreach ($programCourses as $course) {
            ?>
              <div class="smallItem well well-small">
                  <a href="index.php?mod=registration&view=programs&action=viewCourse&course_id=<?php echo $course['course_id']; ?>&program_id=<?php echo $program_id; ?>"
                     class="title"><?php echo $course['name']; ?></a>
                  <span class="buttons"><a
                          href="index.php?mod=registration&ajax=removeCourseFromProgram&program_id=<?php echo $program_id; ?>&course_id=<?php echo $course['course_id']; ?>"
    ...
    <div class="programRequirements">
        <h3>Enrollment Requirements - <a
                href="index.php?mod=registration&view=programs&action=addRequirement&program_id=<?php echo $program_id; ?>"
        ...
        foreach ($programRequirements as $requirement) {
          ?>
            <div class="smallItem well well-small">
                ...
                <span class="buttons"><a
                        href="index.php?mod=registration&ajax=deleteRequirementFromProgram&program_id=<?php echo $program_id; ?>&requirement_id=<?php echo $requirement['requirement_id']; ?>"
    ...
    <div class="programFees">
        <h3>Applicable Fees - <a
                href="index.php?mod=registration&view=programs&action=addFee&program_id=<?php echo $program_id; ?>"
      ...
      foreach ($programFees as $fee) {
        ?>
          <div class="bigItem well">
              ...
              <span class="buttons"><a
                      href="index.php?mod=registration&ajax=deleteFeeFromProgram&program_id=<?php echo $program_id; ?>&fee_id=<?php echo $fee['fee_id']; ?>"
              ...
              <div class="itemDetails well">
                  ...
                  - <a
                      href="index.php?mod=registration&view=programs&action=addCondition&program_id=<?php echo $program_id; ?>&fee_id=<?php echo $fee['fee_id'] ?>"
                ...
                if ($fee['conditions']) {
                  ...
                  foreach ($fee['conditions'] as $condition) {
                    echo "<span id=\"condition_".$condition['program_fee_condition_id']."\">".$i.". ".$condition['name']." - <a href=\"index.php?mod=registration&ajax=deleteFeeConditionFromProgram&program_id=".$program_id."&program_fee_condition_id=".$condition['program_fee_condition_id']."\" class=\"deleteButton btn btn-small btn-danger\" ref=\"".$condition['program_fee_condition_id']."\" title=\"Delete this condition.\">Remove</a></span><br />";
                    $i++;
                  }
                }
                ?>
