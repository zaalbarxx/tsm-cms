...
<div class="span9">
  ...
  <?php foreach ($feeConditions as $condition) { ?>
    <div class="smallItem well well-small">
      ...
      <span class="buttons">
      <a href="index.php?mod=registration&view=programs&action=addCondition&program_id=<?php echo $program_id; ?>&addCondition=<?php echo $condition['fee_condition_id']; ?>&fee_id=<?php echo $fee_id; ?>"
