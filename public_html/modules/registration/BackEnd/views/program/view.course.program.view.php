...
<div class="span9">
    ...
    <!--<div class="availablePeriods">
  	<h3>Available Periods - <a href="index.php?mod=registration&view=courses&action=addPeriod&course_id=<?php echo $course_id; ?>" class="addButton24 fb" style="bottom:-5px" title="Add a Period"></a></h3>
    ...
    <div class="courseRequirements">
        <h3>Enrollment Requirements - <a
                href="index.php?mod=registration&view=courses&action=addRequirement&course_id=<?php echo $course_id; ?>&program_id=<?php echo $program_id; ?>"
    ...
    <div class="courseFees">
        <h3>Applicable Fees - <a
                href="index.php?mod=registration&view=courses&action=addFee&course_id=<?php echo $course_id; ?>&program_id=<?php echo $program_id; ?>"
        ...
        ?>
          <div class="bigItem">
              ...
              <div class="itemDetails">
                  ...
                  - <a
                      href="index.php?mod=registration&view=courses&action=addCondition&course_id=<?php echo $course_id; ?>&fee_id=<?php echo $fee['fee_id'] ?>&program_id=<?php echo $program_id; ?>"
                      class="fb">Add</a>
                  <br/>
                <?php
                if ($fee['conditions']) {
    ...
    <div class="courseRoster">
        <h3>Course Roster - <a
                href="index.php?mod=registration&view=programs&action=viewProgram&action=viewCourse&program_id=<?php echo $program_id; ?>&course_id=<?php echo $course_id; ?>&downloadCSV=1"
