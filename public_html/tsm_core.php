...
require_once(__TSM_ROOT__.'classes/tsm.module.class.php');
require_once(__TSM_ROOT__.'classes/tsm.template.class.php');
require_once(__TSM_ROOT__.'classes/adminUser.class.php');
require_once(__TSM_ROOT__.'classes/website.class.php');
require_once(__TSM_ROOT__.'includes/3rdparty/mpdf/mpdf.php');
?>