...
$config = array( //'cookie_httponly' => true,		// Whether or not to set the cookie as HTTP-ONLY (defaults to TRUE)
...
$Federator = new QuickBooks_IPP_Federator($private_key, $dsn, $callback, $config);
