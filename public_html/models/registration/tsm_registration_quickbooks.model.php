...
Class TSM_REGISTRATION_QUICKBOOKS extends TSM_REGISTRATION{
	...
	public function __construct(){
		...
		*/
		...
		$this->this_url = 'http://localhost/sandbox/admin/index.php?com=registration&view=quickbooks&action=connect';
		$this->that_url = 'http://localhost/sandbox/admin/index.php?com=registration&view=quickbooks&action=connected';
